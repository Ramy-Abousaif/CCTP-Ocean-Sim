...
public class WaterMesh : MonoBehaviour
{
    ...
    void InstantiateMeshes()
    {
        ...
        //for (int i = 0; i < clipLevels; i++)
        //{
        //    rings.Add(InstantiateElement("Ring " + i, ring, fft.renderingShader_Material));
        //    trims.Add(InstantiateElement("Trim " + i, trim, fft.renderingShader_Material));
        //}
        //skirt = InstantiateElement("Skirt", CreateSkirtMesh(k, skirtSize), fft.renderingShader_Material);
    }
